# genpark-pan-african-cross-border-payment-gateway-skill
...
> **GenPark AI Agent Skill** -- Pan-African and global cross-border payment gateway with mobile money rails (Flutterwave style)
